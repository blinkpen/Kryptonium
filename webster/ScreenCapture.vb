...
' unchanged => not all function have been used in this Magnifying Glass project
...
Namespace ScreenShot
    ...
    Public Class ScreenCapture
        ...
        Private Class GDI32
            ...
            Declare Function StretchBlt Lib "gdi32.dll" (
                ByVal hDestDC As IntPtr,
                ByVal x As Int32,
                ByVal y As Int32,
                ByVal nWidth As Int32,
                ...
                ByVal xSrc As Int32,
                ByVal ySrc As Int32,
                ByVal srcWidth As Int32,
                ByVal srcHeight As Int32,
                ByVal dwRop As Int32) As Int32
